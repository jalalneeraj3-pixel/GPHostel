...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const user = await axios.post("http://localhost:9000/sign-up", data, {
                    headers: {
                    ...
                    <div className="card p-3 shadow">
                        <form onSubmit={handleSubmit}>
                            <div className="mb-3">
                                ...
                                <input onChange={handleFormChange} value={formValue.name} type="text" className="form-control" placeholder="Enter Name" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Email</label>
                                <input onChange={handleFormChange} value={formValue.email} type="text" className="form-control" placeholder="Enter Email" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Branch</label>
                                <input onChange={handleFormChange} value={formValue.branch} type="text" className="form-control" placeholder="Enter Branch Name" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">UBTER</label>
                                <input onChange={handleFormChange} value={formValue.rollno} type="text" className="form-control" placeholder="Enter Roll No." />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Contact</label>
                                <input onChange={handleFormChange} value={formValue.contact} type="text" className="form-control" placeholder="Enter Contact" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Password</label>
                                <div className="input-group mb-3">
                                    <input onChange={handleFormChange} value={formValue.password} type={show === true ? 'text' : 'password'} className="form-control" placeholder="Enter Password" />
